...
<head>
    ...
    <title>MY GIRL>3</title>
    <!-- Add styles if you want -->
    <style>
        body {
            font-family: Arial, sans-serif;
            background-color: #2c3e50; /* Dark color for the background */
            color: #fff;
            text-align: center;
            margin: 50px;
        }
        ...
        .container {
            ...
            margin: 0 auto;
            padding: 30px;
            background-color: #000; /* Set container background color to black */
            background-image: url('https://source.unsplash.com/800x600/?dark-books'); /* Replace with your dark aesthetic book image URL */
